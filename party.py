...
def is_mel(name, email):
    """Is this user Mel?
        ...
        >>> is_mel('asdf', 'mel@ubermelon.com')
        True

        >>> is_mel('Mel Melitpolski', 'asdf')
        True
...
def most_and_least_common_type(treats):
    """Given list of treats, return {most, least} common types.
        ...
        >>> most_and_least_common_type([{'who': 'Heather', 'type': 'dessert','description': 'Chocolate mousse'}])
        ('dessert', 'dessert')

        >>> most_and_least_common_type([{'who': 'Heather', 'type': 'dessert', 'description': 'Chocolate mousse'}, {'who': 'Meggie', 'type': 'appetizer', 'description': 'Humboldt Fog cheese'}])
        ('dessert', 'dessert')
